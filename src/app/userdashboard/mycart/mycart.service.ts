...
export class MycartService {
  ...
  showCartItem() {
    if (localStorage.getItem('currentUser')) {
      ...
      return this.http.get(Config.api + 'purchase/getchecklist/' + JSON.parse(localStorage.getItem('currentUser')).user_id, {headers: headers}).map((response: Response) => response.json());
    }
  }
}
